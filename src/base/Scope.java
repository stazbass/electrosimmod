...
import elements.LogicOutputElm;
import elements.MemristorElm;
import elements.OutputElm;
import elements.ProbeElm;
import elements.TransistorElm;
...
public class Scope {
	...
	public void draw(Graphics g) {
		...
		if (sim.scopeSelected == -1 && elm == sim.getMouseElm())
